...
import { alternatesFor, articleJsonLd, blogPostPath } from "@/lib/seo";
 ...
 *
 * Les imports sont paresseux et non pas en tête de fichier : trente-deux composants
 * importés d'emblée pour n'en rendre qu'un seul alourdiraient chaque page du guide.
 * Les chemins restent des littéraux — c'est ce qui permet au bundler de les résoudre.
 */
