 ...
 * page de chiffres a donc pris son propre chemin, `/dashboard/statistiques`, et `/dashboard`
 * n'est plus qu'une porte.
 *
 ...
 * Le calendrier garde son chemin à lui, et le proxy garde sa liste courte.
 *
 * Le rôle restreint n'arrive jamais jusqu'ici : le proxy le renvoie déjà sur
 * `restrictedHome`, qui est cette même destination.
 */
